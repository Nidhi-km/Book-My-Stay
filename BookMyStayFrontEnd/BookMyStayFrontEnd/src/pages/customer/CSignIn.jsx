    ...
    return (
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#F5F7FA] to-[#E4EBF5] p-4 font-outfit relative">
            ...
            <div className="w-full max-w-md bg-white shadow-2xl rounded-2xl p-8 border border-[#F5C518]/40">
                <h1 className="text-[#0A2647] font-bold text-3xl text-center mb-2">Login</h1>
                ...
                {/* <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-3">
                        ...
                        <Link to="/customer/signup" className="flex items-center justify-center gap-2 w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-100 transition-all">
                            <UserPlus size={18} /> 
                        </Link>
                    </div>
                </div> */}
